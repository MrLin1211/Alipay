...
public final class AlipaySignUtils {
    ...
    public static String buildContent(Map<String, String> params) {
        return buildContent(params, true);
    }

    private static String buildContent(Map<String, String> params, boolean includeSignType) {
    ...
    public static boolean verifyRsa2(Map<String, String> params, String alipayPublicKeyPem, String sign) {
        ...
        try {
            ...
            signature.update(buildContent(params, false).getBytes(StandardCharsets.UTF_8));
